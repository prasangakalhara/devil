              ...
              <div class="md:flex">
                <div class="w-full p-3">
                  <div class="relative">
                    ...
                    <input
                      type="text"
                      class="bg-white h-14 w-full px-4 pr-20 border border-dark border-start-0 border-end-0 border-top-0 rounded-md "
                      name=""
                    />
                    <button
                      class="h-50 rounded bg-black absolute top-2 text-sm right-2 px-3 text-white  "
                      Style="height:50px;"
                    >
                      Subscribe Now
                    </button>{" "}
